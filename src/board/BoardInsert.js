                ...
                <Grid container>
                    ...
                    <Grid xs={12} md={12}>
                        <div className="board_top_input_box">
                            ...
                            <input type="text" name="title" id="title" className="board_ist_title inputTop" placeholder="제목을 입력하세요." onChange={changeTitle}/><br/>
                            <label for="comment" className="board_ist_input_font">설명</label><br/>
                            <input type="text" name="comment" id="comment" className="board_ist_title inputTop" placeholder="설명을 입력하세요." onChange={changeComment}/><br/> 
                            <label for="comment" className="board_ist_input_font">포인트</label><br/>
                            <input type="text" name="requirepoint" id="requirepoint" className="board_ist_title inputTop" placeholder="포인트를 입력하세요." onChange={changePoint}/>
                        </div>
                    </Grid>
                    {
                        rows.map((row,i)=>{
